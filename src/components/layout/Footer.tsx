...
export default function Footer() {
  return (
    <footer id="contact" className="relative bg-slate-950 text-slate-400 pt-16 pb-12 border-t border-slate-900">
      ...
      {/* Floating Stacked Action Buttons */}
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3.5 items-center">
        {/* Floating Call Button */}
        <a
          href="tel:7069300605"
          className="flex h-13 w-13 items-center justify-center rounded-full bg-slate-950 text-[#FFB800] border border-slate-700/90 shadow-2xl transition-all hover:scale-110 hover:bg-slate-900 shadow-slate-950/40 cursor-pointer"
          aria-label="Call Lucifer Cabs"
          title="Call Now: 7069300605"
        >
          <Phone className="h-6 w-6 fill-[#FFB800]" />
        </a>
